public class DependencyVersion {
    // keeping all versions in one place makes sure we don't forget to update them somewhere
    // all versions in code are pointing here
    public static final String spring = "3.0.9";
    public static final String kotlin = "1.9.0";
    public static final String springDependencyManagementPlugin = "1.1.3";
